    ...
    <div class="h-full w-full flex flex-col lg:flex-row items-center gap-8">
      ...
      <div class="flex-col lg:flex-row flex justify-left items-center">
        <div class="relative max-w-[45%]">
          ...
          <div class="absolute top-[42.5%] left-[33.5%] w-[5%] h-[3%]">
          ...
          <div class="absolute top-[75.5%] left-[51.5%] w-[5%] h-[3%]">
          ...
          <div class="absolute top-[65.5%] left-[45.5%] w-[5%] h-[3%]">
          ...
          <div class="absolute top-[65.5%] left-[50.5%] w-[5%] h-[3%]">
          ...
          <div class="absolute top-[82.5%] left-[39.5%] w-[5%] h-[3%]">
          ...
          <div class="absolute top-[48.5%] left-[45.5%] w-[5%] h-[3%]">
          ...
          <div class="absolute top-[35.5%] left-[42.5%] w-[5%] h-[3%]">
          ...
          <div class="absolute top-[21.5%] left-[37.5%] w-[5%] h-[3%]">
          ...
          <div class="absolute top-[16.5%] left-[5.5%] w-[5%] h-[3%]">
          ...
          <div class="absolute top-[33.5%] left-[15.5%] w-[5%] h-[3%]">
